/**
 * GPU Transition Constraint Evaluation Kernel - Part 1/4
 * Handles transition constraints 100-199 (of 398 total)
 */
...
#include "gpu/kernels/quotient_transition_part1_generated.cuh"

namespace triton_vm::gpu::kernels {

__global__ void quotient_transition_part1_kernel(
    ...
    triton_vm::gpu::Xfe acc = triton_vm::gpu::quotient_gen::eval_transition_part1_weighted(
...
void launch_quotient_transition_part1(
    ...
    quotient_transition_part1_kernel<<<grid, block, 0, stream>>>(
