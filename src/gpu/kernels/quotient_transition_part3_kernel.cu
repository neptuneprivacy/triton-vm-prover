/**
 * GPU Transition Constraint Evaluation Kernel - Part 3/4
 * Handles transition constraints 300-399 (of 398 total)
 */
...
#include "gpu/kernels/quotient_transition_part3_generated.cuh"

namespace triton_vm::gpu::kernels {

__global__ void quotient_transition_part3_kernel(
    ...
    triton_vm::gpu::Xfe acc = triton_vm::gpu::quotient_gen::eval_transition_part3_weighted(
...
void launch_quotient_transition_part3(
    ...
    quotient_transition_part3_kernel<<<grid, block, 0, stream>>>(
