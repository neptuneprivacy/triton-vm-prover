/**
 * GPU Transition Constraint Evaluation Kernel - Part 2/4
 * Handles transition constraints 200-299 (of 398 total)
 */
...
#include "gpu/kernels/quotient_transition_part2_generated.cuh"

namespace triton_vm::gpu::kernels {

__global__ void quotient_transition_part2_kernel(
    ...
    triton_vm::gpu::Xfe acc = triton_vm::gpu::quotient_gen::eval_transition_part2_weighted(
...
void launch_quotient_transition_part2(
    ...
    quotient_transition_part2_kernel<<<grid, block, 0, stream>>>(
