...
// DO NOT EDIT MANUALLY. Regenerate with: python3 tools/gen_gpu_quotient_constraints.py
...
__device__ __forceinline__ Xfe eval_transition_weighted(const Bfe* current_main_row, const Xfe* current_aux_row, const Bfe* next_main_row, const Xfe* next_aux_row, const Xfe* challenges, const Xfe* weights) {
