...
#[clap(name = "xnt-dashboard", about = "Terminal user interface")]
pub struct Config {
...
impl DashboardApp {
    ...
    fn render(&mut self, f: &mut Frame) {
        ...
        let title = format!("♆ xnt-dashboard — {network}");
        let title = Line::from(title);
        let title_style = Style::default()
            .add_modifier(Modifier::BOLD)
            .bg(Color::Black)
            .fg(Color::Rgb(49, 64, 167));
        ...
        let focus_style = default_style.fg(Color::Rgb(49, 64, 167));
        let selection_style = Style::default().fg(Color::Black).bg(Color::Gray);
        let focus_selection_style = selection_style.bg(Color::Rgb(49, 64, 167));
