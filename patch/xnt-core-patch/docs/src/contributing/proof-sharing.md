...
Many tests in `xnt-core` rely on cryptographic STARK proofs of correct
...
were produced (and placed in `xnt-core/test_data/`) during the execution of
the test suite.
...
If you want to serve your proofs directly from your `xnt-core` repository,
