...
The documentation for Neptune Cash lives in the [`xnt-core`](https://github.com/Neptune-Crypto/xnt-core) repository under `docs/`. It uses [mdBook](https://rust-lang.github.io/mdBook/), a documentation-as-a-website engine popular with rust projects. The source material consists of [Markdown](https://commonmark.org/) files, and MdBook renders them as HTML pages.
