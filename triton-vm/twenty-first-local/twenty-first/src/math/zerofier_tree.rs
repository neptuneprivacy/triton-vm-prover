...
pub struct Leaf<'c, FF: FiniteField + MulAssign<BFieldElement> + FieldKind> {
...
#[derive(Debug, Clone, PartialEq)]
pub struct Branch<'c, FF: FiniteField + MulAssign<BFieldElement> + FieldKind> {
    zerofier: Polynomial<'c, FF>,
...
where
    FF: FiniteField + MulAssign<BFieldElement> + FieldKind + 'static,
{
...
#[derive(Debug, Clone, PartialEq)]
pub enum ZerofierTree<'c, FF: FiniteField + MulAssign<BFieldElement> + FieldKind> {
    Leaf(Leaf<'c, FF>),
    Branch(Box<Branch<'c, FF>>),
    Padding,
}

impl<FF: FiniteField + MulAssign<BFieldElement> + FieldKind> ZerofierTree<'static, FF> {
